...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: UserPartiePatron::class, mappedBy: 'User', orphanRemoval: true)]
    ...
    public function removeUserPartiePatron(UserPartiePatron $userPartiePatron): static
    {
        if ($this->userPartiePatrons->removeElement($userPartiePatron)) {
            ...
            if ($userPartiePatron->getUser() === $this) {
                $userPartiePatron->setUser(null);
            }
        }
